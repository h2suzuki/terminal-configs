...
2. **Cross-reference an existing skill** — 同じ project 内の既存 skill を 1-2 個 sample で Read する (例: `verify-before-asserting`, `subagent-gate`, `code-writing`)。 frontmatter pattern と section 構成が template 通りか実例で確認。
