...
- `evidence-reporting` — 判定 / 推奨 / 影響評価 を発話する前に公式情報 / コード / 文書を読み根拠を示す。 本 skill の 「実機構の中立提示」 と補完
- `verify-before-asserting` — positive assertion 前の verify。 本 skill の 「結論は実態の上に立ち上がる」 と精神同根
