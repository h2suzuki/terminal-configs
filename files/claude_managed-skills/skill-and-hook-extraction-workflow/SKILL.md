...
- `feature_findings_build.py` hook → `${XDG_CACHE_HOME:-~/.cache}/claude-code-feature-research/findings.md`: Claude Code spec delta を SessionStart で公式 changelog から決定的に build して累積
