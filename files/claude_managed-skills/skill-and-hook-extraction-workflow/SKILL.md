...
- `claude-code-feature-cache.sh` hook → `${XDG_CACHE_HOME:-~/.cache}/claude-code-feature-cache/findings.md`: `claude --bg -p` / `claude agents` 等 hidden flag の delta を SessionStart bg research で累積
