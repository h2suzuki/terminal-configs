...
- `claude-code-feature-research.sh` hook → `${XDG_CACHE_HOME:-~/.cache}/claude-code-feature-research/findings.md`: Claude Code spec delta の cache (auto mode 周りの classifier 挙動も spec delta があれば記録される)
