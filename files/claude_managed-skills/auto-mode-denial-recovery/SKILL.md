...
- `claude-code-feature-cache.sh` hook → `${XDG_CACHE_HOME:-~/.cache}/claude-code-feature-cache/findings.md`: Claude Code spec delta の cache (auto mode 周りの classifier 挙動も spec delta があれば記録される)
