...
1 mode (payload の hook_event_name / tool_name で dispatch):
...
DELEGATE_MSG = (
    ...
    "レビューします (auth / data-loss / race 等の高リスクは /codex:adversarial-review で"
    " 独立 cross-model 第二レビュー)。 trivial な変更・doc 編集・codex 利用不可時は "
    "self-implement で構いません。"
)
