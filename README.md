...
| 分野 | 主な内容 |
|---|---|
| OS設定 | Bash、Git、Neovim、SSH keepalive、Windows Terminal の認識、WSL2 の systemd・mDNS・ホスト名・WSLg 向け PulseAudio 音声転送 |
| ターミナル | GitHub CLI、ripgrep、delta、libsixel-bin、uv・ruff・ty、Node.js LTS（nvm）、Chrome |
