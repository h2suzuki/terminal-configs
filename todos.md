...
- [ ] **残 (保留受入条件)**: H.S. による wording review — managed CLAUDE.md「ツールに役割委譲」節 + tool-role-delegation skill の文言 (実装・live 動作は完了済、 文言 polish のみ)。 任意 v2: Read-deny / plan-intent 解析 / `Agent` matcher 誘導
