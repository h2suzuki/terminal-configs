...
- [ ] codegraph-first gate (PreToolUse Grep(+Read)): codegraph index freshness(mtime) + 当turn未照会 を判別 → 適時 deny + `codegraph_explore` 誘導、非code/index無/照会済は fail-open allow
